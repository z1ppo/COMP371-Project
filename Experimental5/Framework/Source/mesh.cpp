...
void mesh::draw(unsigned int programId)
{
	...
	GLuint vertex = glGetAttribLocation(programId, "vertexPosition_modelspace"); //0
	GLuint normal = glGetAttribLocation(programId, "vertexNormal_modelspace"); //1
	//GLuint tangent = glGetAttribLocation(programId, "tangent"); //2
	//GLuint color = glGetAttribLocation(programId, "color"); //3
	GLuint UV = glGetAttribLocation(programId, "vertexUV"); //4
